...
$status = Join-Path 'C:\Users\asus\Desktop\nowcasting_benchmark-main\nowcasting_benchmark-main\logs\us_notebook_run_20260513' 'status.csv'
$summary = Join-Path 'C:\Users\asus\Desktop\nowcasting_benchmark-main\nowcasting_benchmark-main\logs\us_notebook_run_20260513' 'summary.txt'
...
foreach ($nb in $notebooks) {
  ...
  $log = Join-Path 'C:\Users\asus\Desktop\nowcasting_benchmark-main\nowcasting_benchmark-main\logs\us_notebook_run_20260513' ($nb + '.log')
