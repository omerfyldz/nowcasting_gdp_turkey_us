...
## Scatter plots
These plots show full-panel m3 RMSFE plotted against average absolute nowcast revision across m1/m2/m3 for the same forecast date. They are generated from the finalized US and Turkey prediction CSVs by `python data/generate_figures.py`. The ideal model is closer to the lower-left corner, but the x-axis is not historical GDP data-revision volatility.
![](images/fig1.png)
![](images/fig2.png)

## Graphical results
These plots show actuals and nowcasts at different time vintages for each methodology, with United States and Turkey panels. Ordered alphabetically. A full list of generated paper-facing figures is available in `figures/FIGURE_INDEX.md`.
![](images/app1.png)
![](images/app2.png)
![](images/app3.png)
![](images/app4.png)
